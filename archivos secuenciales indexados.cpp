...
ifstream indic("index.txt", ios::binary);			//declaracion de archivo para buscar datos leyendolos
...
cin>>opcion;					//se almacena la opcion que escribamos
cout<<endl;
...
indic.close();//cierra archivo indic de busqueda
...
//y aqui es donde finaliza el programa
}
